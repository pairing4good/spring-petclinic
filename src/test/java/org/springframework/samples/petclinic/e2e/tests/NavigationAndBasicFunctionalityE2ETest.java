...
/**
 * Comprehensive E2E tests for navigation and basic functionality.
 * Tests all main navigation flows and page verification.
 */
public class NavigationAndBasicFunctionalityE2ETest extends BaseE2ETest {
	...
	void asAUser_IWantToNavigateToVeterinarians_SoThatICanViewTheListOfVets() {
		...
		// Verify specialties
		assertEquals("none", vetsPage.getVeterinarianSpecialties("James Carter"), "James Carter should have no specialties");
		assertEquals("radiology", vetsPage.getVeterinarianSpecialties("Helen Leary"), "Helen Leary should have radiology specialty");
	}
	...
	void asAUser_IWantToNavigateToErrorPage_SoThatICanSeeHowErrorsAreHandled() {
		...
		assertTrue(errorPage.getErrorHeadingText().contains("Something happened"), "Error heading should contain expected text");
